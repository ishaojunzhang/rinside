...
//
// Simple example showing creating a Rcpp::List, modify it in R and pass back to cpp
//
...
int main(int argc, char *argv[]) {
    ...
    // R.parseEvalQ(r_code); Rcpp::List reslist = R["myRlist"];
    Rcpp::List reslist( (SEXP) R.parseEval(r_code));
    show(reslist);
